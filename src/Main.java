...
public class Main {
    ...
    public static void main(String[] args) {
    	//changed scope of expense addition
        expenses.add(1000);
        expenses.add(2300);
        expenses.add(45000);
        expenses.add(32000);
    ...
    private static void searchExpenses(ArrayList<Integer> arrayList, Integer value) {
        ...
        //presenting results
        if (flag) {
            System.out.println("Expense located: " + value);
        } else {
            System.out.println("Expense not found: " + value);
        }
    }
    ...
    private static void sortExpenses(ArrayList<Integer> arrayList) {
        ...
        //output 
        System.out.println("Expenses have now been sorted: \n" + arrayList);
    }
}